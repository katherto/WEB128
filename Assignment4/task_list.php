...
<body>
    ...
    <main>
        ...
        <form action="." method="post" >
            ...
            <!--additional code to determine if the promote task button should be shown 
            (I don't recall this being in the book but your email made sense and it was easy to implement-->
            ...
            <br><br>
            <label>&nbsp;</label>
            <!--additional code to determine if the sort button shows or not-->
            <?php if (count($task_list) > 1) : ?>
